...
export default function EditarRelatorioPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const isRegistro = ["ACUMULADOR", "ALAGAMENTOS", "ZELADORIA"].includes(relatorio.tipoServico);
  const isRevitalizacao = relatorio.tipoServico === "REVITALIZACAO";
  const isDDS = relatorio.tipoServico === "DDS";
  const isMonumentos = relatorio.tipoServico === "MONUMENTOS";
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-blue-100">
              ...
              {isMonumentos && "Edite as informações dos monumentos"}
